  ...
  return (
    <main className="flex w-full h-screen">
      ...
      />
        ...
        <h3 className="text-xl absolute top-[370px] left-[60px] font-[550] text-left text-stone-500 leading-[20px] tracking-tight w-[640px] z-10" style={{ fontFamily: 'Poppins, sans-serif' }}>

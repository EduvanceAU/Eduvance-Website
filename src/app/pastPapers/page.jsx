...
import { supabase } from '../subjects/template/IAL/lib/supabaseClient';
              ...
              {selected === "IAL" ? (
                <>
                  <h1 className="text-4xl font-semibold leading-[40px] tracking-tighter mb-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    <span className="bg-[#0C58E4] text-white py-[1.5] px-1 -rotate-1 inline-block">IAL</span> Past Papers
                  </h1>
                ...
                <>
                  <h1 className="text-4xl font-semibold leading-[40px] tracking-tighter mb-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
                    <span className="bg-[#0C58E4] text-white py-[1.5] px-1 -rotate-1 inline-block">IGCSE</span> Past Papers
                  </h1>
                  {/* Links like in Resources page */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full">

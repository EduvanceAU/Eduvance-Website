...
export default function Mathematics() {
  ...
  return (
    <main className="flex w-full h-screen">
      <img src="/Math_Banner.png" alt="Chemistry" className="w-full h-[210px]"/>
          ...
          {selected === "option1" ? (
            <>
              ...
              <div className="absolute top-[-20px] flex justify-center items-center space-x-8 mt-40">
                ...
                <Link href="/sub_links/maths/pastpapers" className="w-95 h-40 bg-[#F2F6FF] rounded-xl border-[1.5px] border-[#153064] flex items-end justify-start pl-4 pb-4 text-[#153064] hover:bg-[#BAD1FD] transition-all duration-300 cursor-pointer">
                  Past Papers
                </Link>
              </div>

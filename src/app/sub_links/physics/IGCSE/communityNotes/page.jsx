...
const units = [
  { name: "IGCSE Physics", code: "4PH1", unit: "IGCSE" },
  ...
  { name: "Practical Skills in Physics I", code: "WBI13", unit: "Unit 3" },
  ...
  { name: "Practical Physics & Investigation Skills", code: "WBI16", unit: "Unit 6" },
];

const subjects = [
  { name: "Physics", link: "/sub_links/physics/IGCSE/communityNotes" },
  { name: "Chemistry", link: "/sub_links/chemistry/IGCSE/communityNotes" },
  { name: "Physics", link: "/sub_links/Physics/IGCSE/communityNotes" },
  { name: "Maths", link: "/sub_links/maths/IGCSE/communityNotes" },
];
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center justify-start py-10 m-10">
      <div className="w-full max-w-5xl px-4">
        ...
        >
          IGCSE <span className="bg-[#1A69FA] px-2 py-1 -rotate-1 inline-block"><span className="text-[#FFFFFF]">Physics</span></span> Community Notes
        </h1>
        ...
        <h3
          ...
          style={{ fontFamily: "Poppins, sans-serif" }}
        >
          Explore our collection of Edexcel IGCSE Physics community-contributed resources, including detailed notes, explanations, and revision tips. These resources are perfect for deepening your understanding, clarifying tricky concepts, and supporting your study alongside past papers.
        </h3>

...
export default function Physics() {
  ...
  return (
    <div className="flex min-h-screen bg-white overflow-hidden">
      {/* Sidebar */}
      <div 
        className="fixed left-0 top-0 h-full w-76 bg-white z-30 flex flex-col"
      ...
      <div className={`ml-64 mt-16 flex-1 transition-all duration-300 ${isDimmed ? 'opacity-30' : 'opacity-100'}`}>
        <main className="flex flex-col w-full min-h-screen relative">
          ...
          <div 
            className="w-full h-[210px] relative flex items-center px-6 bg-cover bg-center bg-no-repeat"
          ...
          <div className="flex flex-col items-center w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 pt-12 md:pt-9 relative">
                ...
                <>
                  ...
                  <div className="flex flex-wrap justify-center md:justify-between gap-4 md:gap-6 mb-8">
                    <Link
                      ...
                      className="hover-tint w-full sm:w-[calc(50%-8px)] md:w-[calc(33.33%-16px)] h-40 rounded-xl font-[550] tracking-[-0.5px] border-[1.5px] border-[#0C58E4] flex items-end justify-start pl-4 pb-4 text-[#0C58E4] hover:bg-[#BAD1FD] transition-all duration-300 cursor-pointer"
            ...
            <div className="flex flex-wrap justify-between gap-4 w-full">
              <Link
                href="/sub_links/physics/askQuestion"
                className="hover-tint w-full sm:w-[calc(50%-8px)] h-14 rounded-xl font-[550] tracking-[-0.5px] border-[1.5px] border-[#0C58E4] flex items-center justify-start pl-4 text-[#0C58E4] hover:bg-[#BAD1FD] transition-all duration-300"
              >
                <img src="/NotesIcon.png" alt="Ask" className="w-4 h-5 mr-4" />
                Add Your Own Notes
              </Link>

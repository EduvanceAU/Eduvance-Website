...
// Removed: const subjectName = 'Biology'; // Will be dynamic
// Removed: const subjectSlug = subjectName.toLowerCase().replace(/\s+/g, '-'); // Will be derived from router
// Removed: const examCode = 'OIB'; // Will be dynamic
    ...
    const fetchPapersData = async () => {
      ...
      try {
        ...
        if (subjectError || !subjectData) {
          const errMsg = subjectError ? subjectError.message : `Subject ID for "biology" not found for papers.`;

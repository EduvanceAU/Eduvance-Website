...
// Removed: const subjectName = 'Chemistry'; // Will be dynamic
// Removed: const subjectSlug = subjectName.toLowerCase().replace(/\s+/g, '-'); // Will be derived from router
// Removed: const examCode = 'WCH1'; // Will be dynamic
    ...
    const fetchPapersData = async () => {
      ...
      try {
        ...
        if (subjectError || !subjectData) {
          const errMsg = subjectError ? subjectError.message : `Subject ID for "chemistry" not found for papers.`;
        ...
        <div className="w-full max-w-5xl px-4">
          ...
          >
            <span className="text-md font-medium text-black tracking-tight">
              <span className="font-[501]">Exam code:</span> WCH1 {/* This now uses the state */}
            </span>
          </div>

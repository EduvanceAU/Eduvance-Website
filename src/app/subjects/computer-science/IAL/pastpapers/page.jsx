    ...
    <>
      <main className="min-h-screen bg-white flex flex-col items-center justify-start py-10 m-10">
        <div className="w-full max-w-5xl px-4">
          ...
          >
            IAL <span className="bg-[#1A69FA] px-2 py-1 -rotate-1 inline-block"><span className="text-[#FFFFFF]">Computer Science</span></span> Past Papers
          </h1>
          ...
          <h3
            ...
            style={{ fontFamily: "Poppins, sans-serif" }}
          >
            Explore our collection of Edexcel IAL Computer Science Past Papers and Mark Schemes below. Practicing with IAL Computer Science past papers is one of the most effective ways to pinpoint the topics that need more focus—helping you revise smarter and prepare confidently for your upcoming exam
          </h3>

...
// Removed: const subjectName = 'Computer Science'; // Will be dynamic
// Removed: const subjectSlug = subjectName.toLowerCase().replace(/\s+/g, '-'); // Will be derived from router
// Removed: const examCode = '4CP0'; // Will be dynamic
    ...
    const fetchPapersData = async () => {
      ...
      try {
        ...
        if (subjectError || !subjectData) {
          const errMsg = subjectError ? subjectError.message : `Subject ID for "computer-science" not found for papers.`;

...
const subjects = [
  { name: subjectName, link: `/subjects/economics/$IGCSE/communityNotes` },
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center justify-start py-10 m-10">
      <div className="w-full max-w-5xl px-4">
        ...
        >
          IGCSE <span className="bg-[#1A69FA] px-2 py-1 -rotate-1 inline-block"><span className="text-[#FFFFFF]">Economics</span></span> Community Notes
        </h1>
        ...
        <h3
          ...
          style={{ fontFamily: "Poppins, sans-serif" }}
        >
          Explore our collection of Edexcel IGCSE Economics community-contributed resources, including detailed notes, explanations, and revision tips. These resources are perfect for deepening your understanding, clarifying tricky concepts, and supporting your study alongside past papers.
        </h3>

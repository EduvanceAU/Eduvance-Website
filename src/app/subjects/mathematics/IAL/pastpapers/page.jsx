...
// Removed: const subjectName = 'Mathematics'; // Will be dynamic
// Removed: const subjectSlug = subjectName.toLowerCase().replace(/\s+/g, '-'); // Will be derived from router
// Removed: const examCode = 'MAT'; // Will be dynamic
    ...
    const fetchPapersData = async () => {
      ...
      try {
        ...
        if (subjectError || !subjectData) {
          const errMsg = subjectError ? subjectError.message : `Subject ID for "mathematics" not found for papers.`;
        ...
        <div className="w-full max-w-5xl px-4">
          ...
          >
            <span className="text-md font-medium text-black tracking-tight">
              <span className="font-[501]">Exam code:</span> MAT {/* This now uses the state */}
            </span>
          </div>

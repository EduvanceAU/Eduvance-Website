...
export default function IGCSEPastPapersPage() {
  ...
  const fetchPapers = async () => {
    ...
    try {
      ...
      if (subjectError || !subjectData) {
        const errMsg = subjectError ? subjectError.message : `Subject "physics" not found.`;
  ...
  const fetchUnits = async () => {
    ...
    try {
      ...
      if (subjectError || !subjectData) {
        const errMsg = subjectError ? subjectError.message : `Subject "physics" not found for units.`;
        setError(new Error(errMsg));

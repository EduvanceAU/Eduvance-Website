...
// Removed: const subjectName = 'Psychology'; // Will be dynamic
// Removed: const subjectSlug = subjectName.toLowerCase().replace(/\s+/g, '-'); // Will be derived from router
// Removed: const examCode = 'PSY'; // Will be dynamic
    ...
    const fetchPapersData = async () => {
      ...
      try {
        ...
        if (subjectError || !subjectData) {
          const errMsg = subjectError ? subjectError.message : `Subject ID for "psychology" not found for papers.`;
